...
class SmallStrainIsotropicDamagePlaneStress extends Material {
    constructor() {
        super(); 
        ...
        this.yieldsurfaceproperties = {
            "VonMises" : ["DENSITY", "YOUNG_MODULUS", "POISSON_RATIO", "THICKNESS", "YIELD_STRESS", "FRACTURE_ENERGY", "SOFTENING_TYPE"],
            "Tresca" : ["DENSITY", "YOUNG_MODULUS", "POISSON_RATIO", "THICKNESS", "YIELD_STRESS", "FRACTURE_ENERGY", "SOFTENING_TYPE"],
            "Rankine" : ["DENSITY", "YOUNG_MODULUS", "POISSON_RATIO", "THICKNESS", "YIELD_STRESS", "FRACTURE_ENERGY", "SOFTENING_TYPE"],
            "MohrCoulomb" : ["DENSITY", "YOUNG_MODULUS", "POISSON_RATIO", "THICKNESS", "YIELD_STRESS", "YIELD_STRESS_COMPRESSION", "FRACTURE_ENERGY", "SOFTENING_TYPE", "FRICTION_ANGLE","COHESION"],
            "ModifiedMohrCoulomb" : ["DENSITY", "YOUNG_MODULUS", "POISSON_RATIO", "THICKNESS", "YIELD_STRESS", "YIELD_STRESS_COMPRESSION", "FRACTURE_ENERGY", "SOFTENING_TYPE","FRICTION_ANGLE"],
            "DruckerPrager" : ["DENSITY", "YOUNG_MODULUS", "POISSON_RATIO", "THICKNESS", "YIELD_STRESS", "YIELD_STRESS_COMPRESSION", "FRACTURE_ENERGY", "SOFTENING_TYPE", "FRICTION_ANGLE", "DILATANCY_ANGLE"],
            "SimoJu" : ["DENSITY", "YOUNG_MODULUS", "POISSON_RATIO", "THICKNESS", "YIELD_STRESS", "FRACTURE_ENERGY", "SOFTENING_TYPE"],
        }
    ...
    onExecute()
    {
        var output = {
            ...
            "Material"        : {
                "constitutive_law" : {
                    "name" : "SmallStrainIsotropicDamagePlaneStress"
                },
                "Variables"        : {
                },
                "Tables"           : {}
...
SmallStrainIsotropicDamagePlaneStress.title = "Small strain isotropic damage plane stress";
SmallStrainIsotropicDamagePlaneStress.desc = "Node to specify a elastic isotropic material.";

LiteGraph.registerNodeType("Materials/StructuralMechanics/SmallStrainIsotropicDamagePlaneStress", SmallStrainIsotropicDamagePlaneStress);

console.log("SmallStrainIsotropicDamagePlaneStress node created"); //helps to debug
