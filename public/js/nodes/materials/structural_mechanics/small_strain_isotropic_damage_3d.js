...
class SmallStrainIsotropicDamage3D extends Material {
    constructor() {
        super(); 
    ...
    onExecute()
    {
        var output = {
            ...
            "Material"        : {
                "constitutive_law" : {
                    "name" : "SmallStrainIsotropicDamage3D"
                },
                "Variables"        : {
                },
                "Tables"           : {}
...
SmallStrainIsotropicDamage3D.title = "Small strain isotropic damage 3D";
SmallStrainIsotropicDamage3D.desc = "Node to specify a elastic isotropic material.";

LiteGraph.registerNodeType("Materials/StructuralMechanics/SmallStrainIsotropicDamage3D", SmallStrainIsotropicDamage3D);

console.log("SmallStrainIsotropicDamage3D node created"); //helps to debug
